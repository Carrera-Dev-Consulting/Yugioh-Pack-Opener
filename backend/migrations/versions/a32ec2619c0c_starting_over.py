...
Revision ID: a32ec2619c0c
Revises: 
Create Date: 2024-03-04 15:59:41.070864
...
def upgrade() -> None:
    ...
    op.create_table('yugioh_card_ban_list_entries',
    ...
    op.create_table('yugioh_card_images',
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('card_id', sa.String(length=36), nullable=False),
    ...
    op.create_table('yugioh_card_prices',
    sa.Column('card_id', sa.String(length=36), nullable=False),
